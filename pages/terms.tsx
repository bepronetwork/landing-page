        ...
        <div className="container-fluid bg">
          <div className="row justify-content-center">
            <div className="col-md-10">
              ...
              <p className="strong mt-5">B. ELIGIBILITY, ACCEPTABLE USE AND REPRESENTATIONS & WARRANTIES</p>
              ...
              <p className="strong mt-5">C. LICENSE</p>
              ...
              <p className="strong mt-5">D. WEBSITE DOMAIN AND TRADEMARKS</p>
              ...
              <p className="strong mt-5">E. USER CONTENT & THIRD PARTY WEBSITES, NETWORKS  AND PLATFORMS</p>
              ...
              <p className="strong mt-5">F. INFORMATION ABOUT US AND OUR SERVICES & PRODUCTS</p>
              ...
              <p className="strong mt-5">G. MODIFICATION OF THESE TERMS</p>
              ...
              <p className="strong mt-5">H. THE $BEPRO TOKEN</p>
              ...
              <p className="strong mt-5">I. IDEMNIFICATION</p>
              ...
              <p className="strong mt-5">J. ABSENCE OF WAIVER</p>
              ...
              <p className="strong mt-5">K. GOVERNING LAW, JURISDICTION & SURVIVAL</p>
              ...
              <p className="strong mt-5">L. CONTACT US</p>
