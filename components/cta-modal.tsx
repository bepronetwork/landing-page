        ...
        <Modal.Body>
          <div className="d-flex flex-column align-items-center px-3">
            <p className="text-white mb-0 mt-4 text-right family-inter fs-small">
              The Bepro Network Protocol is a decentralized protocol deployed in Moonriver created by TAIKAI SA, this protocol is a tool to attach in Git Protocol Centralized SDKs to create incentives for developers to decentralize development in a liquid manner and with scale.
            </p>
            <p className="text-white-50 mb-0 mt-4 text-right family-inter fs-small">
              By joining the website you agree to the <a href="https://www.bepro.network/terms-and-conditions" className="text-primary bg-opacity-100" target="_blank" rel="noreferrer">Terms & Conditions</a>, including not being in an excluded jurisdiction and you accept the Risks of using experimental technology in the Moonriver EVM
            </p>
          </div>
        </Modal.Body>
        <Modal.Footer>
          <div className="d-flex flex-row justify-content-between align-items-center p-3 pt-0">
            <a className="text-decoration-none" href={appLink} target="_blank" rel="noreferrer">
